...
Frequently used code provided from the udacity course to build api, and used many posts in Stack Overflow, and various online tutorials to complete the project.
